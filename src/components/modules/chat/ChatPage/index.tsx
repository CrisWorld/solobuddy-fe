...
export function ChatContent() {
  ...
  // Add toggle function for expanding/collapsing guides
  ...
  const handleSendMessage = async () => {
    ...
    try {
      // Only get user messages for API request
            ...
            <div key={msg.id}>
              {msg.type === "user" ? (
                ...
                <div className="flex gap-3">
                  <Avatar className="h-8 w-8 mt-1 flex-shrink-0 ring-2 ring-primary/10"> {/* Added ring */}
                          ...
                          >
                            {expandedResponses[msg.id] ? (
                              ...
                              <>
                                ...
                                View all {msg.tourGuides.length} suggestions
                              </>
                            )}
                          </Button>
                        )}
          ...
          {isLoading && (
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <div className="bg-white rounded-2xl py-2 px-4 shadow-sm w-fit"> {/* Added w-fit */}
      ...
      <div className="bg-white border-t border-border p-4 shadow-sm">
        <div className="max-w-2xl mx-auto">
          <div className="flex gap-2">
            <Input
              placeholder="Ask me anything about tour guides..."
              value={message}
